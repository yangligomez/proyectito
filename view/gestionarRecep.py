...
class VentanaGestionarRecepcionista:
    def __init__(self, ventana_principal):
        ...
        botones = [
            ("Registrar\nRecepcionista", self.registrar_recepcionista, "Registrar un nuevo recepcionista"),
            ("Editar\nRecepcionista", self.editar_recepcionista, "Editar datos de un recepcionista"),
            ("Eliminar\nRecepcionista", self.eliminar_recepcionista, "Eliminar un recepcionista del sistema"),
            ("Listar/Buscar\nRecepcionistas", self.listar_recepcionistas, "Ver y buscar recepcionistas registrados"),
        ]
    ...
    def listar_recepcionistas(self):
        pass
...
if __name__ == "__main__":
    root = tk.Tk()
    root.withdraw()
    VentanaGestionarRecepcionista(root)
    root.mainloop()
